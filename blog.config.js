...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '558da1b6946e45399cfdf7acc1758972',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CreamgGreen.', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的大鞋生📕', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://creamgreen.xyz', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, Hi，我是一个二游人,Hi，我是一个管人吃,欢迎来到我的博客🎉',
