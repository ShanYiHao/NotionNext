...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, Hi，我是一个管人痴,Hi，我是一个干饭人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'XiaoYi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个摆烂电兵⚡', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-ashen-seven.vercel.app', // 网站地址
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      cover:
        'https://p2.music.126.net/qhcfRnSXfNToa66ff7S8Kw==/109951167879453336.jpg'
    },
    {
      name: 'Windy Hill',
      artist: '羽肿',
      ...
      cover:
        'https://p2.music.126.net/R5wdneWJADdilEDtqBev-w==/109951169463411528.jpg'
    }
  ],
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '9351949398', // 对应歌单的 id
